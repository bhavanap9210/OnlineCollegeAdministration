<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCStaffEdit.ascx.cs"
    Inherits="OCA.UserControls.UCStaffEdit" %>
<div>
...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            <ajaxToolkit:MaskedEditExtender ID="meExtZipCode" runat="server" TargetControlID="txtZipCode" ClearTextOnInvalid="false"
                Mask="99999" MessageValidatorTip="true" ClearMaskOnLostFocus="false" OnFocusCssClass="MaskedEditFocus"
