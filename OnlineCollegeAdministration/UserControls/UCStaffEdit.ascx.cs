...
{
    public partial class UCStaffEdit : CustomUserControl
    {
        ...
        public override void LoadUserControlData()
        {
            ...
            StaffIDText = _commonHelper.GetUserIdText();
            ...
            if (string.IsNullOrEmpty(StaffIDText) || Mode == "V")
            {
        ...
        private void BindData()
        {
            ...
            IDataReader dr = new StaffDAL().GetStaffRecord(StaffIDText, "N");
            if (dr != null)
            {
                dt.Load(dr);
            ...
            if (dt != null)
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    StaffID = cmnHelper.GetStringValueFrmColumn(dt, "staff_id", 0);
