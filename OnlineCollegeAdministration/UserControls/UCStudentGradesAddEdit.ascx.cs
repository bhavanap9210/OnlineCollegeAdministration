...
{
    public partial class UCStudentGradesAddEdit : CustomUserControl
    {
        ...
        {
            DataTable dt = new DataTable();
            IDataReader dr = new StudentGradeDAL().GetStudentGradeRecord(StaffId, CourseDurationId, StudentID,StaffCourseId, "I");
