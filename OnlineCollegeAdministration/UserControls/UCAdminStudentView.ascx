<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAdminStudentView.ascx.cs" Inherits="OCA.UserControls.UCAdminStudentView" EnableTheming="true" %>
...
<table>
    ...
    <tr>
        <td>
            <asp:GridView ID="gvStudent" runat="server" AutoGenerateColumns="false" AllowPaging="true"  OnPageIndexChanging="gvStudent_PageIndexChanging"
                AllowSorting="false" PageSize="20" ShowHeaderWhenEmpty="true" ShowHeader="true" SkinID="GVSkin" DataKeyNames="student_id">
                <EmptyDataTemplate>
