...
{
    public partial class UCStudentEdit : CustomUserControl
    {
        ...
        public override void LoadUserControlData()
        {
            ...
            StudentIDText = _commonHelper.GetUserIdText();
            if (_commonHelper.IsinRole("2"))
            {
                Mode = "E";
            }
            else
            ...
            if (string.IsNullOrEmpty(StudentIDText) || Mode == "V")
            {
        ...
        private void BindData()
        {
            ...
            IDataReader dr = new StudentDAL().GetStudentRecord(StudentIDText, "N");
            if (dr != null)
            {
                dt.Load(dr);
            ...
            if (dt != null)
            {
                if (dt.Rows.Count > 0)
                {
                    ...
                    StudentID = cmnHelper.GetStringValueFrmColumn(dt, "student_id", 0);
        ...
        private string ValidateFields()
        {
            ...
            if (string.IsNullOrEmpty(txtLastName.Text.Trim())
                ...
                || string.IsNullOrEmpty(txtChangePassword.Text.Trim()))
            {
