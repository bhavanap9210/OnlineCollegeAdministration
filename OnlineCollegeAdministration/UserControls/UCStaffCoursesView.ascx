<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCStaffCoursesView.ascx.cs"
    Inherits="OCA.UserControls.UCStaffCoursesView" %>
<table>
    <tr>
        <td>
            <table>
    ...
    <tr>
        <td>
            <asp:GridView ID="gvCourse" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                ...
                ShowHeaderWhenEmpty="true" ShowHeader="true" SkinID="GVSkin" DataKeyNames="course_duration_id">
                <EmptyDataTemplate>
